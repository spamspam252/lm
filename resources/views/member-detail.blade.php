...
<main id="book-detail-section" class="container">
      <div class="row">
        <div class="col s12 valign-wrapper">
          <h3>Member M001</h3><a id="edit-member-detail-button" class="btn-floating btn-large waves-effect waves-light blue lighten-1 valign"><i id="edit-member-detail-button-icon" class="fa fa-pencil-square-o"></i></a>
        </div>
      </div>
        ...
        <div class="col s12">
          <div class="row">
            <div class="input-field col s12"><i class="fa fa-book prefix"></i>
              <input type="text" name="member-name" disabled value="&lt;?php echo 'member-name-detail'; ?&gt;" id="member-name-detail">
              <label for="member-name-detail">Name</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12 left-align"><i class="fa fa-credit-card prefix"></i>
              <input type="text" name="member-cmnd" disabled value="&lt;?php echo 'member-cmnd-detail'; ?&gt;" id="member-cmnd-detail">
              <label for="member-cmnd-detail">CMND</label>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 left-align"><i class="fa fa-calendar-minus-o left prefix"></i>
              <label for="expired-date">EXPIRED DATE</label>
              <input type="date" disabled id="expired-date">
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12 left-align"><i class="material-icons prefix teal-text text-lighten-2">work</i>
              <select id="member-type-detail">
                <option value="student" selected data-icon="{{URL::to('assets/icon/Student-48.png')}}" class="circle left">Student</option>
          ...
          <div id="renting-books-content" class="row no-more-margin-bottom">
            <div class="col s12">
              <ul data-collapsible="accordion" class="collapsible light-blue lighten-4">
                <li>
                  <div class="collapsible-header blue lighten-1 white-text">Rent History<i class="fa fa-bookmark"></i></div>
          ...
          <div class="row right">
            <div class="col s12"><a href="{{route('list-member')}}" class="waves-effect waves-green btn-flat">Cancel</a><a href="{{route('list-member')}}"class="waves-effect waves-green btn">OK</a></div>
          </div>
        </div>
      </div>
    </main>
