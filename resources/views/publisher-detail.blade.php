...
@section('content')
<main id="publisher-detail-section" class="container">
  <div class="row">
    <div class="col s12 valign-wrapper">
      <h3>Publisher A001</h3><a href="#!" id="edit-publisher-detail-button" class="btn-floating btn-large waves-effect waves-light blue lighten-1 valign"><i id="edit-publisher-detail-button-icon" class="fa fa-pencil-square-o"></i></a>
    </div>
  </div>
    ...
    <div class="col s12">
      <div class="row">
        <div class="input-field col s12"><i class="fa fa-book prefix"></i>
          <input type="text" name="publisher-name" disabled value="&lt;?php echo 'publisher-name-detail'; ?&gt;" id="publisher-name-detail">
          <label for="publisher-name-detail">Name</label>
        </div>
      </div>
      ...
      <div class="row right">
        <div class="col s12"><a href="{{route('list-publisher')}}" class="waves-effect waves-green btn-flat">Cancel</a><a href="{{route('list-publisher')}}"class="waves-effect waves-green btn">OK</a></div>
      </div>
    </div>
  </div>
</main>
